...
namespace TrackerUI.ChildForms
{
    ...
    public partial class CEV : Form
    {
        ...
        private List<CevModel> CalculateCevRequested()
        {
            ...
            cevRequested = NoSQL_Connector.GetCevByPosParallel("IPray2Buddha", "3-max", QueriesExtensionMethods.ConcatQueries(cevRequestQueries.sql_ExportCevPerTournamentAsJSON, cevRequestQueries.sql_cevRequestGeneral_test));
            return cevRequested;
        }
