...
namespace TrackerLibrary.CRUD
{
    public class DataManager_DashBoard
    {
        ...
        private static List<CevModel> RequestCevModel_TotalByTournament(string hero, string tourneyType, SettingsModel.Settings settings)
        {
        ...
        private static List<CevModel> RequestCevModel_TotalByMonth(string hero, string tourneyType, SettingsModel.Settings settings)
        {
        ...
        private static List<CevModel> RequestCevModel_3W_BTNvBBvREG(string hero, string tourneyType, SettingsModel.Settings settings)
        {
        ...
        private static List<CevModel> RequestCevModel_3W_BTNvBBvFISH(string hero, string tourneyType, SettingsModel.Settings settings)
        {
            return QueriesExtensionMethods.ConcatQueries(settings.DbTypeRead == DataBaseType.NoSQL.GetDescription() ? NoSQL_DashBoardQueries.sql_ExportTlpOverviewAsJSON_CevByPos_GroupByMonths : SQL_DashBoardQueries.sql_ExportTlpOverviewAsJSON_CevByPos_GroupByMonths, 
        ...
        private static List<CevModel> RequestCevModel_3W_SBvBTNvREG(string hero, string tourneyType, SettingsModel.Settings settings)
        {
            return QueriesExtensionMethods.ConcatQueries(settings.DbTypeRead == DataBaseType.NoSQL.GetDescription() ? NoSQL_DashBoardQueries.sql_ExportTlpOverviewAsJSON_CevByPos_GroupByMonths : SQL_DashBoardQueries.sql_ExportTlpOverviewAsJSON_CevByPos_GroupByMonths, 
        ...
        private static List<CevModel> RequestCevModel_3W_SBvBTNvFISH(string hero, string tourneyType, SettingsModel.Settings settings)
        {
            return QueriesExtensionMethods.ConcatQueries(settings.DbTypeRead == DataBaseType.NoSQL.GetDescription() ? NoSQL_DashBoardQueries.sql_ExportTlpOverviewAsJSON_CevByPos_GroupByMonths : SQL_DashBoardQueries.sql_ExportTlpOverviewAsJSON_CevByPos_GroupByMonths, 
        ...
        private static List<CevModel> RequestCevModel_3W_BBvBTNvREG(string hero, string tourneyType, SettingsModel.Settings settings)
        {
            return QueriesExtensionMethods.ConcatQueries(settings.DbTypeRead == DataBaseType.NoSQL.GetDescription() ? NoSQL_DashBoardQueries.sql_ExportTlpOverviewAsJSON_CevByPos_GroupByMonths : SQL_DashBoardQueries.sql_ExportTlpOverviewAsJSON_CevByPos_GroupByMonths, 
        ...
        private static List<CevModel> RequestCevModel_3W_BBvBTNvFISH(string hero, string tourneyType, SettingsModel.Settings settings)
        {
            return QueriesExtensionMethods.ConcatQueries(settings.DbTypeRead == DataBaseType.NoSQL.GetDescription() ? NoSQL_DashBoardQueries.sql_ExportTlpOverviewAsJSON_CevByPos_GroupByMonths : SQL_DashBoardQueries.sql_ExportTlpOverviewAsJSON_CevByPos_GroupByMonths, 
        ...
        private static List<CevModel> RequestCevModel_3W_SBvBBvREG(string hero, string tourneyType, SettingsModel.Settings settings)
        {
            return QueriesExtensionMethods.ConcatQueries(settings.DbTypeRead == DataBaseType.NoSQL.GetDescription() ? NoSQL_DashBoardQueries.sql_ExportTlpOverviewAsJSON_CevByPos_GroupByMonths : SQL_DashBoardQueries.sql_ExportTlpOverviewAsJSON_CevByPos_GroupByMonths, 
        ...
        private static List<CevModel> RequestCevModel_3W_SBvBBvFISH(string hero, string tourneyType, SettingsModel.Settings settings)
        {
            return QueriesExtensionMethods.ConcatQueries(settings.DbTypeRead == DataBaseType.NoSQL.GetDescription() ? NoSQL_DashBoardQueries.sql_ExportTlpOverviewAsJSON_CevByPos_GroupByMonths : SQL_DashBoardQueries.sql_ExportTlpOverviewAsJSON_CevByPos_GroupByMonths, 
        ...
        private static List<CevModel> RequestCevModel_3W_BBvSBvREG(string hero, string tourneyType, SettingsModel.Settings settings)
        {
            return QueriesExtensionMethods.ConcatQueries(settings.DbTypeRead == DataBaseType.NoSQL.GetDescription() ? NoSQL_DashBoardQueries.sql_ExportTlpOverviewAsJSON_CevByPos_GroupByMonths : SQL_DashBoardQueries.sql_ExportTlpOverviewAsJSON_CevByPos_GroupByMonths, 
        ...
        private static List<CevModel> RequestCevModel_3W_BBvSBvFISH(string hero, string tourneyType, SettingsModel.Settings settings)
        {
            return QueriesExtensionMethods.ConcatQueries(settings.DbTypeRead == DataBaseType.NoSQL.GetDescription() ? NoSQL_DashBoardQueries.sql_ExportTlpOverviewAsJSON_CevByPos_GroupByMonths : SQL_DashBoardQueries.sql_ExportTlpOverviewAsJSON_CevByPos_GroupByMonths, 
        ...
        private static List<CevModel> RequestCevModel_HU_SBvREG(string hero, string tourneyType, SettingsModel.Settings settings)
        {
            return QueriesExtensionMethods.ConcatQueries(settings.DbTypeRead == DataBaseType.NoSQL.GetDescription() ? NoSQL_DashBoardQueries.sql_ExportTlpOverviewAsJSON_CevByPos_GroupByMonths : SQL_DashBoardQueries.sql_ExportTlpOverviewAsJSON_CevByPos_GroupByMonths, 
        ...
        private static List<CevModel> RequestCevModel_HU_SBvFISH(string hero, string tourneyType, SettingsModel.Settings settings)
        {
            return QueriesExtensionMethods.ConcatQueries(settings.DbTypeRead == DataBaseType.NoSQL.GetDescription() ? NoSQL_DashBoardQueries.sql_ExportTlpOverviewAsJSON_CevByPos_GroupByMonths : SQL_DashBoardQueries.sql_ExportTlpOverviewAsJSON_CevByPos_GroupByMonths, 
        ...
        private static List<CevModel> RequestCevModel_HU_BBvREG(string hero, string tourneyType, SettingsModel.Settings settings)
        {
            return QueriesExtensionMethods.ConcatQueries(settings.DbTypeRead == DataBaseType.NoSQL.GetDescription() ? NoSQL_DashBoardQueries.sql_ExportTlpOverviewAsJSON_CevByPos_GroupByMonths : SQL_DashBoardQueries.sql_ExportTlpOverviewAsJSON_CevByPos_GroupByMonths, 
        ...
        private static List<CevModel> RequestCevModel_HU_BBvFISH(string hero, string tourneyType, SettingsModel.Settings settings)
        {
            return QueriesExtensionMethods.ConcatQueries(settings.DbTypeRead == DataBaseType.NoSQL.GetDescription() ? NoSQL_DashBoardQueries.sql_ExportTlpOverviewAsJSON_CevByPos_GroupByMonths : SQL_DashBoardQueries.sql_ExportTlpOverviewAsJSON_CevByPos_GroupByMonths, 
        ...
        public static DashBoardModel RequestDashBoard(string hero, string tourneyType, SettingsModel.Settings settings)
        {
