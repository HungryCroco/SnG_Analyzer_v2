...
namespace TrackerLibrary.CRUD
{
    public class NoSQL_CalculateDashBoard
    {
        ...
        private static List<CevModel> RequestCevModel_TotalByTournament(string hero, string tourneyType, DataBaseType dbType)
        {
            return QueriesExtensionMethods.ConcatQueries(dbType == DataBaseType.NoSQL ? NoSQL_DashBoardQueries.sql_ExportCevPerTournamentAsJSON : SQL_DashBoardQueries.sql_ExportCevPerTournamentAsJSON, hero: hero, tourneyType: tourneyType).GetCevChartParallel<CevModel>();
        }

        private static List<CevModel> RequestCevModel_TotalByMonth(string hero, string tourneyType, DataBaseType dbType)
        {
            return QueriesExtensionMethods.ConcatQueries(dbType == DataBaseType.NoSQL ? NoSQL_DashBoardQueries.sql_ExportTlpOverviewAsJSON_CevTotal_GroupByMonths : SQL_DashBoardQueries.sql_ExportTlpOverviewAsJSON_CevTotal_GroupByMonths,
                hero: hero, tourneyType: tourneyType).GetCevChartParallel<CevModel>();
        }
        ...
        public static DashBoardModel RequestDashBoard(string hero, string tourneyType, DataBaseType dbType)
        {
            ...
            else
            {
                ...
                Task t1 = Task.Run(() => { dashBoardModel.CevModel_Total_ByTournament = RequestCevModel_TotalByTournament(hero, tourneyType, dbType); });
                Task t2 = Task.Run(() => { dashBoardModel.CevModel_Total_ByMonth = RequestCevModel_TotalByMonth(hero, tourneyType, dbType); });

                Task t3 = Task.Run(() => { dashBoardModel.CevModel_3W_BTNvBBvREG = RequestCevModel_3W_BTNvBBvREG(hero, tourneyType, dbType); });
                Task t4 = Task.Run(() => { dashBoardModel.CevModel_3W_BTNvBBvFISH = RequestCevModel_3W_BTNvBBvFISH(hero, tourneyType, dbType); });
                Task t5 = Task.Run(() => { dashBoardModel.CevModel_3W_SBvBTNvREG = RequestCevModel_3W_SBvBTNvREG(hero, tourneyType, dbType); });
                Task t6 = Task.Run(() => { dashBoardModel.CevModel_3W_SBvBTNvFISH = RequestCevModel_3W_SBvBTNvFISH(hero, tourneyType, dbType); });
                Task t7 = Task.Run(() => { dashBoardModel.CevModel_3W_BBvBTNvREG = RequestCevModel_3W_BBvBTNvREG(hero, tourneyType, dbType); });
                Task t8 = Task.Run(() => { dashBoardModel.CevModel_3W_BBvBTNvFISH = RequestCevModel_3W_BBvBTNvFISH(hero, tourneyType, dbType); });

                Task t9 = Task.Run(() => { dashBoardModel.CevModel_3W_SBvBBvREG = RequestCevModel_3W_SBvBBvREG(hero, tourneyType, dbType); });
                Task t10 = Task.Run(() => { dashBoardModel.CevModel_3W_SBvBBvFISH = RequestCevModel_3W_SBvBBvFISH(hero, tourneyType, dbType); });
                Task t11 = Task.Run(() => { dashBoardModel.CevModel_3W_BBvSBvREG = RequestCevModel_3W_BBvSBvREG(hero, tourneyType, dbType); });
                Task t12 = Task.Run(() => { dashBoardModel.CevModel_3W_BBvSBvFISH = RequestCevModel_3W_BBvSBvFISH(hero, tourneyType, dbType); });

                Task t13 = Task.Run(() => { dashBoardModel.CevModel_HU_SBvREG = RequestCevModel_HU_SBvREG(hero, tourneyType, dbType); });
                Task t14 = Task.Run(() => { dashBoardModel.CevModel_HU_SBvFISH = RequestCevModel_HU_SBvFISH(hero, tourneyType, dbType); });
                Task t15 = Task.Run(() => { dashBoardModel.CevModel_HU_BBvREG = RequestCevModel_HU_BBvREG(hero, tourneyType, dbType); });
                Task t16 = Task.Run(() => { dashBoardModel.CevModel_HU_BBvFISH = RequestCevModel_HU_BBvFISH(hero, tourneyType, dbType); });
